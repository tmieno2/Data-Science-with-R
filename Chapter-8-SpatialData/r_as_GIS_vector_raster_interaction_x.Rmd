...
<br>
<br>
```{r map-wells-county, fig.cap = "A map of Kansas irrigation wells and HPA", eval = F}
...
.right6[
```{r map-wells-county-f, ref.label = "map-wells-county", echo = F, out.width = "100%"}	
...
+ Note the lines that go beyond the Kansas boundary are also selected (remember, the default is `st_intersect()`). 
