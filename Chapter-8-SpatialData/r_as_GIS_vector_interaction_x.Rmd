...
This function identifies whether two spatial objects are within the distance you specify as the name suggests.  
...
```{r map-points-points-points, echo = F, out.width = "60%"}
ggplot() +
...
```{r points-points-within, echo = F, out.width = "60%"}
...
The part of the lines that did not intersect with a polygons is cut out and does not remain in the returned `sf`. To see this, see Figure \@ref(fig:lines-polygons-int) below:
