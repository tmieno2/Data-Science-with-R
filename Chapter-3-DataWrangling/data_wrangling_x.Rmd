...
.content-box-green[**Preparation 1**] 
...
.content-box-green[**Preparation 2**]
...
Evaluate `corn_yields_df` and `corn_yields_tbl` to see the differences.

<br>

.content-box-green[**Data read using `read.csv()`**]

```{r }
class(corn_yields_df)
```

.content-box-green[**Data read using `read_csv()`:**]
...
.content-box-green[**not equal to**]  
...
.content-box-green[**in any of (`%in%`)**] 
...
.content-box-green[**More generally**] 
...
.content-box-green[**Alternative 1**] 
...
.content-box-green[**Alternative 2 (with piping)**]
...
.content-box-green[**multiple variables**] 
