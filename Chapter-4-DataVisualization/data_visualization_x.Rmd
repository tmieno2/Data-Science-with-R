...
output:
  xaringan::moon_reader:
    ...
    css: ["xaringan-themer.css", "extension.css"] 
    lib_dir: libs
    nature:
      ratio: 16:10
...
.right6[
```{r ref.label = "cor-plot", echo = F, cache = F, fig.dim = c(7, 5)}  
...
.right-plot[
```{r ref.label = "diverging2", echo = F, fig.dim = c(4, 4.3), out.width = "90%", dependson = "diverging"}  
