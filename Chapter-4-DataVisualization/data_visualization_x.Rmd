...
.right-plot[
```{r ref.label = "g-fig-scatter", echo = F, out.width = "90%"}  
...
.right-plot[
```{r ref.label = "density_type", echo = F, out.width = "90%"}  
...
.right-plot[
```{r ref.label = "line_type", echo = F, out.width = "90%"}  
```
]
...
.right-plot[
```{r ref.label = "boxplot_type", echo = F, out.width = "90%"}  
...
.right-plot[
```{r ref.label = "barplot_type", echo = F, out.width = "90%"}  
...
.right-plot[
```{r ref.label = "corn-color-dif", echo = F, out.width = "90%"}  
...
.right-plot[
```{r ref.label = "density-fill", echo = F, cache = TRUE, out.width = "90%"}  
```
]
...
.right-plot[
```{r ref.label = "box-fill", echo = F, cache = TRUE, out.width = "90%"}  
```
]
...
.right-plot[
```{r ref.label = "scatter-color", echo = F, cache = TRUE, out.width = "90%"}  
...
.right-plot[
```{r ref.label = "facet-ex", echo = F, out.width = "90%"}  
...
.right-plot[
```{r ref.label = "two-ex", echo = F, out.width = "90%"}  
...
.right-plot[
```{r ref.label = "grid-ex-2", echo = F, out.width = "90%", out.width = "90%"}  
...
.right-plot[
```{r ref.label = "free-x", echo = F, out.width = "90%"}  
...
.right-plot[
```{r ref.label = "free-y", echo = F, out.width = "90%"}  
...
.right-plot[
```{r ref.label = "free", echo = F, out.width = "90%"}  
...
.right-plot[
```{r ref.label = "hv-line", echo = F, out.width = "90%"}  
```
]
...
.right-plot[
```{r ref.label = "ab-line", echo = F, out.width = "90%"}  
```
]
...
.right-plot[
```{r ref.label = "smooth", echo = F, out.width = "90%"}  
...
.right-plot[
```{r ref.label = "ribbon", echo = F, out.width = "90%"}  
...
.right-plot[
```{r ref.label = "text-ex", echo = F, out.width = "90%"}  
...
.right-plot[
```{r ref.label = "annotate", echo = F, out.width = "90%"}  
...
.right-plot[
```{r ref.label = "multi", echo = F, out.width = "90%"}  
...
.right-plot[
```{r ref.label = "at-font", echo = F, out.width = "90%"}
...
.right-plot[
```{r ref.label = "at-line", echo = F, out.width = "90%"}
...
.right-plot[
```{r ref.label = "at-ticks", echo = F, out.width = "90%"}
...
.right-plot[
```{r echo = F, dependson = "starting-point", out.width = "90%"}  
g_l
```
]
...
.right-plot[
```{r ref.label = "l-position", echo = F, dependson = "starting-point", out.width = "90%"}  
...
.right-plot[
```{r ref.label = "key", echo = F, out.width = "90%"}  
...
.right-plot[
```{r ref.label = "font", echo = F, out.width = "90%"}  
...
.right-plot[
```{r ref.label = "background", echo = F, out.width = "90%"}  
...
.right-plot[
```{r ref.label = "bw", echo = F, out.width = "90%"}  
...
.right-plot[
```{r ref.label = "void", echo = F, out.width = "90%"}  
...
.right-plot[
```{r ref.label = "stata", echo = F, out.width = "90%"}  
...
.right-plot[
```{r ref.label = "gdocs", echo = F, out.width = "90%"}  
...
.right-plot[
```{r ref.label = "economist", echo = F, out.width = "90%"}  
...
.right-plot[
```{r ref.label = "excel", echo = F, out.width = "90%"}  
...
.right-plot[
```{r ref.label = "start-panel", echo = F, out.width = "90%"}  
...
.right-plot[
```{r ref.label = "panel-grid-minor", echo = F, out.width = "90%"}
...
.right-plot[
```{r ref.label = "panel-grid-major", echo = F, out.width = "90%"}
...
.right-plot[
```{r ref.label = "st-text", echo = F, out.width = "90%"}
...
.right-plot[
```{r ref.label = "st-background", echo = F, out.width = "90%"}
...
.right-plot[
```{r ref.label = "p-spacing", echo = F, out.width = "90%"}
...
.right-plot[
```{r ref.label = "f-fam", echo = F, out.width = "90%"}
...
.right-plot[
```{r ref.label = "color-hex", echo = F, out.width = "90%"}
...
.right-plot[
```{r ref.label = "viridis-ex-1", echo = F, out.width = "90%"}
...
.right-plot[
```{r ref.label = "viridis-ex-2", echo = F, out.width = "90%"}
...
.right-plot[
```{r ref.label = "viridis-reverse", echo = F, out.width = "90%"}
...
.right-plot[
```{r ref.label = "rb-ex-1", echo = F, out.width = "90%"}
...
.right-plot[
```{r ref.label = "rb-ex-2", echo = F, out.width = "90%"}
...
.right-plot[
```{r ref.label = "manu-ex", echo = F, out.width = "90%"}
...
```{r echo = F, fig.dim = c(8, 4), out.width = "70%"}
g_f 
```
...
.right-plot[
```{r ref.label = "factor", echo = F, out.width = "90%"}
...
.right-plot[
```{r ref.label = "box-disc", echo = F, out.width = "90%"}
```
]
...
.right-plot[
```{r ref.label = "box-num", echo = F, out.width = "90%"}
```
]
...
.right-plot[
```{r ref.label = "box-char", echo = F, out.width = "90%"}
```
]
...
.right-plot[
```{r ref.label = "weather", echo = F, out.width = "90%"}  
...
.right-plot[
```{r ref.label = "weather-2", echo = F, out.width = "90%"}  
...
.right-plot[
```{r ref.label = "diverging", echo = F, fig.dim = c(4, 4.3), out.width = "90%", dependson = "diverging"}  
...
county_yield %>% 
  ...
  ggplot(data = .) + 
  geom_area(aes(y = corn_yield_p, x = year, fill = state_name), stat = "identity") + 
...
.right-plot[
```{r ref.label = "area-chart", echo = F, out.width = "90%"}  
```
]
...
.right-plot[
```{r ref.label = "encircle", echo = F, out.width = "90%"}  
...
.right-plot[
```{r ref.label = "segment", echo = F, out.width = "90%"}  
...
.right-plot[
```{r ref.label = "curve", echo = F, out.width = "90%"}  
...
`weather` from the the `nycflights13` package has daily weather information at three airports in NY.

```{r eval = F}
gg_box <- ggplot(data = weather) +
  geom_boxplot(aes(y = temp, x = origin, fill = origin)) +
  #--- animate over month ---#
...
.right-plot[
```{r ref.label = "animate", echo = F, out.width = "90%"}  
```
]
...
.right-plot[
```{r ref.label = "animate-2", echo = F, out.width = "90%"}  
```
]
  ]
