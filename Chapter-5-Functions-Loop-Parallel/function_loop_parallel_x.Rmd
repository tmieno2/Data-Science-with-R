...
$$
Max_{N} P_C \times [120 + (1 + slope) * 25 \times log(\mbox{nitrogen rate})] - P_N \times N
$$
...
Here, `N` is a decision variable, `slope` and `EC` is an attribute, and `P_C` and `P_N` are parameters.
